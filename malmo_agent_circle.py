...
class Agent:
    def __init__(self, agents=1):
        ...
        self.actions = ["attack 1", "move 1", "move -1", "strafe 1", "strafe -1", "turn 0.3", "turn -0.3", "pitch 0.3", "pitch -0.3"]
        self.actions_view = ["Attack", "Go_Front", "Go_Back", "Go_Right", "Go_Left", "Look_Right", "Look_Left", "look_Up", "look_down"]
        self.rewards = []
        self.kills = []
        self.prev_kills = 0
        self.player_life = []
    ...
    def play_action(self, action_number):
        ...
        elif action == "pitch 0.3" or action == "pitch -0.3":
            self.malmo_agent.sendCommand(action)
            time.sleep(MS_PER_TICK * 0.0016)
            self.malmo_agent.sendCommand("pitch 0")
        ...
        <Mission xmlns="http://ProjectMalmo.microsoft.com" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
          ...
          <ServerSection>
            ...
            <ServerHandlers>
              ...
              <DrawingDecorator>
                <DrawSphere x="0" y="202" z="0" radius="25" type="wool" colour="ORANGE"/>
