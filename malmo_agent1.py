...
class Agent:
    def __init__(self, agents=1):
        ...
        self.state = [self.zombie_los_in_range, self.zombie_los, self.current_pos[0]
            , self.current_pos[1], self.current_life, self.yaw, self.zombie_yaw[0], self.zombie_yaw[1],
                      self.zombie_yaw[2]
    ...
    def start_episode(self):
        ...
        self.unresponsive_count = UNRESPONSIVE_AGENT
        self.all_zombies_died = False
        # New code Be carefully!!
        self.malmo_agent.sendCommand("pitch 0.1")
